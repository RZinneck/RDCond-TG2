...
<head>
  ...
  <title>Tela principal do síndico</title>
...
<body class="capa-home">
  ...
  <div class="container tela-principal fadeIn">
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-3"></div>
      <div class="col-md-6">
        <form action="registra_condominio.php" method="post">
          <h4>Nome do condomínio</h4>
          <input class="form-control" name="cond_nome" required="requiored"> </input> <br>
